------------
![](https://github.com/elMauro2003/imagenes/blob/main/ticket_system_laravel.png)
...
```
- Ingrese al administrador de [PHP MyAdmin](http://localhost/phpmyadmin/) y cree una nueva base de datos, el nombre es opcional, pero por defecto nombrarla **ticket_system**

- Correr la migraciones del proyecto
```bash
php artisan migrate
```
- Ejecute los seeders, esto creará usuarios de prueba, puede revisar las credenciales en el archivo (**database/seeders/DatabaseSeeder**)
```bash
php artisan db:seed
```
- Ejecute el proyecto
